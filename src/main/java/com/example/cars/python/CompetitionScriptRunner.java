...
public class CompetitionScriptRunner {

    public static void main(String[] args) {
        try {
            // Load the resource as stream
            InputStream scriptStream = CompetitionScriptRunner.class.getResourceAsStream("/importcompetitions1.py");
            ...
            // Copy to a temp file
            File tempScript = File.createTempFile("importcompetitions1", ".py");
